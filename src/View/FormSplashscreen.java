...
public class FormSplashscreen extends javax.swing.JFrame {
        ...
        al = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (pgbLoading.getValue() < 100) {
                    pgbLoading.setValue(pgbLoading.getValue() + 10);
                } else {
                    t.stop();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/GDS - Logo v2.0 - G5_2.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Consolas", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 153));
        jLabel3.setText("Gerenciamento do Depósito de Suprimentos do IFSP - Campus Capivari");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FormSplashscreen().setVisible(true);
            }
        });
    }
